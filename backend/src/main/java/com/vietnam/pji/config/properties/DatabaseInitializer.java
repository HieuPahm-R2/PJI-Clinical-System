...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermission == 0) {
            ...
            arrResult.add(new Permission("Get episodes by patient", "/api/v1/patients/{patientId}/episodes", "GET",
                    "EPISODES"));

            // MEDICAL_HISTORY
            arrResult.add(new Permission("Create medical history", "/api/v1/episodes/{episodeId}/medical-history",
                    "POST", "MEDICAL_HISTORY"));
            arrResult.add(new Permission("Update medical history", "/api/v1/episodes/{episodeId}/medical-history",
                    "PUT", "MEDICAL_HISTORY"));
            arrResult.add(new Permission("Get medical history", "/api/v1/episodes/{episodeId}/medical-history", "GET",
                    "MEDICAL_HISTORY"));

            // CLINICAL_RECORDS
            arrResult.add(
                    new Permission("Create clinical record", "/api/v1/clinical-records", "POST", "CLINICAL_RECORDS"));
            arrResult.add(new Permission("Update clinical record", "/api/v1/clinical-records/{id}", "PUT",
                    "CLINICAL_RECORDS"));
            arrResult.add(new Permission("Delete clinical record", "/api/v1/clinical-records/{id}", "DELETE",
                    "CLINICAL_RECORDS"));
            arrResult.add(new Permission("Get clinical record by id", "/api/v1/clinical-records/{id}", "GET",
                    "CLINICAL_RECORDS"));
            ...
            arrResult.add(new Permission("Get surgeries by episode", "/api/v1/episodes/{episodeId}/surgeries", "GET",
                    "SURGERIES"));
            ...
            arrResult.add(new Permission("Get lab results by episode", "/api/v1/episodes/{episodeId}/lab-results",
                    "GET", "LAB_RESULTS"));
            ...
            arrResult.add(
                    new Permission("Delete image result", "/api/v1/image-results/{id}", "DELETE", "IMAGE_RESULTS"));
            arrResult.add(
                    new Permission("Get image result by id", "/api/v1/image-results/{id}", "GET", "IMAGE_RESULTS"));
            arrResult.add(new Permission("Get image results by episode", "/api/v1/episodes/{episodeId}/image-results",
                    "GET", "IMAGE_RESULTS"));

            // CULTURE_RESULTS
            arrResult
                    .add(new Permission("Create culture result", "/api/v1/culture-results", "POST", "CULTURE_RESULTS"));
            arrResult.add(
                    new Permission("Update culture result", "/api/v1/culture-results/{id}", "PUT", "CULTURE_RESULTS"));
            ...
            arrResult.add(new Permission("Create sensitivity result", "/api/v1/sensitivity-results", "POST",
                    "SENSITIVITY_RESULTS"));
            arrResult.add(new Permission("Update sensitivity result", "/api/v1/sensitivity-results/{id}", "PUT",
                    "SENSITIVITY_RESULTS"));
            arrResult.add(new Permission("Delete sensitivity result", "/api/v1/sensitivity-results/{id}", "DELETE",
                    "SENSITIVITY_RESULTS"));
            arrResult.add(new Permission("Get sensitivity result by id", "/api/v1/sensitivity-results/{id}", "GET",
                    "SENSITIVITY_RESULTS"));
            arrResult.add(new Permission("Get sensitivity results by culture",
                    "/api/v1/culture-results/{cultureId}/sensitivity-results", "GET", "SENSITIVITY_RESULTS"));
